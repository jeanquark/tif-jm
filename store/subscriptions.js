...
export const actions = {
    ...
    async fetchUserSubscriptions2({ commit }, endpoint) {
        try {
	...
	async createUserSubscriptions ({ commit, rootGetters }, { userTeams, pushSubscription }) {
		try {
	...
	async deleteUserSubscriptions ({ commit, rootGetters }) {
		try {
			const userId = rootGetters['users/loadedUser'].id
			let updates = {}
