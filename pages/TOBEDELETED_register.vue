<template>
	...
	>
		<v-flex>
			<v-container
			    fluid
			    style="max-width: 1017px; padding: 0px; border: 2px solid green;"
			>
				<scoremode-header />
				...
				<v-layout
				    row
				    wrap
				    style="background-color: white; border: 2px solid darkred;"
				>
					<v-flex
					    xs12
					    sm8
					...
					>
						<v-card class="elevation-12">
							<v-card-title
							    align-center
							    justify-center
							    style="background-color: orangered; min-height: 60px;"
							>
